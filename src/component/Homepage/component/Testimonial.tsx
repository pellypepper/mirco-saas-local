  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        'Quick response and excellent service! The plumber was professional and fixed the issue in no time.',
      avatar: 'SJ',
      color: '#0077b6',
    },
    {
    ...
    },
    {
      ...
      rating: 5,
      comment:
        'Very satisfied with the electrician.  Arrived on time, did great work, and cleaned up after.',
      avatar: 'ER',
      color: '#0077b6',
    },
  ];
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => (
            ...
            >
              {/* Card */}
              <div
                className={`relative ${isDarkMode ? 'bg-chart-3/200 border-gray-600 hover:border-zinc-900' : 'bg-white/60 border-white/10 '} rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border hover:border-chart-3/30 h-full`}
              >
                {/* Quote Icon */}
                ...
                {/* Comment */}
                <p
                  className={`${isDarkMode ? 'text-gray-300' : 'text-gray-700'} mb-6 leading-relaxed italic`}
                >
