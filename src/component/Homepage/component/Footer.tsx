...
const Footer = () => {
  ...
  return (
    <footer
      className={`relative ${isDarkMode ? ' text-white bg-zinc-950' : ' text-gray-900'} overflow-hidden`}
    >
      ...
      <div className="relative container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p
              className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-700'} leading-relaxed mb-6`}
            >
              Your trusted platform for connecting with quality service providers in your area. We
              make finding and booking professionals simple, fast, and reliable.
            </p>

            {/* Contact Info */}
            <div className="space-y-3">
              <div
                className={`flex items-center gap-3 text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-700'} hover:text-chart-3 transition-colors`}
              >
          ...
          <div>
            <h3
              className={`font-bold text-lg mb-6 relative inline-block ${isDarkMode ? 'text-white' : 'text-black'}`}
            >
              Quick Links
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
              ...
              <span className="text-chart-2 font-semibold">ServiceHub</span>. All rights reserved.
            </p>
