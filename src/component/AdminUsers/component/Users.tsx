                ...
                <td className="px-6 py-4 text-center">
                  <div className="inline-flex flex-col items-center gap-1">
                    ...
                    <div className="flex gap-1 text-xs">
                      <span className="px-2 py-0.5 bg-chart-2/20 text-chart-2 rounded-full">
                        {user.completedBookings}
                      </span>
                      <span className="px-2 py-0.5 bg-chart-3/20 text-chart-3 rounded-full">
                        {user.pendingBookings}
                      </span>
                      <span className="px-2 py-0.5 bg-chart-1/20 text-chart-1 rounded-full">
