          ...
          <div className="flex justify-between items-start">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <span
                  className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium border ${getStatusColor(selectedBooking.status)} bg-white/70`}
                >
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <span className="text-slate-800">
                    {selectedBooking.location ? selectedBooking.location : 'Location not available'}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="bg-slate-50 rounded-xl p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white rounded-lg p-4 shadow-sm">
                ...
                <p className="text-3xl font-bold text-chart-3">${selectedBooking.amount}</p>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <p className="text-slate-500 text-sm mb-1">Payment Status</p>
                <span
                  className={`inline-block px-4 py-2 rounded-full text-sm font-semibold ${getPaymentColor(selectedBooking.paymentStatus)}`}
                >
