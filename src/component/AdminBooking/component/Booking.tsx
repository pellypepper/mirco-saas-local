        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-slate-100">
            {sortedBookings.map((booking) => (
              <tr key={booking.id} className="hover:bg-chart-2/20 cursor-pointer transition-colors">
                ...
                <td className="px-6 py-4 text-center">
                  <div>
                    <p className="text-lg font-bold text-chart-3">${booking.amount}</p>
                    <span
                      className={`inline-block px-2 py-0.5 rounded-full text-xs font-medium ${getPaymentColor(booking.paymentStatus)}`}
                    >
