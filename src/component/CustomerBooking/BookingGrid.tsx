...
export const CustomerBookingsGrid = ({
  ...
  return (
          ...
          >
            <div className="relative p-6 md:p-8">
              ...
              <div className="flex items-start justify-between gap-4 mb-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="relative">
                    ...
                    >
                      <MoreVertical
                        className={`w-5 h-5 ${isDarkMode ? 'text-zinc-400' : 'text-gray-600'}`}
                      />
                    </button>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                {/* Date & Time */}
                <div
                  className={`${isDarkMode ? 'bg-zinc-900 border-zinc-700' : 'bg-zinc-200 border-2 border-gray-300'} rounded-2xl p-4 hover:border-chart-2 transition-all duration-300`}
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p
                        className={`text-xs ${isDarkMode ? 'text-zinc-500' : 'text-gray-500'} font-bold uppercase mb-1`}
                      >
                        Date & Time
                      </p>
                      <p
                      ...
                      <p
                        className={` text-sm mt-1" ${isDarkMode ? 'text-zinc-400' : 'text-gray-600'}`}
                      >
                ...
                {/* Duration */}
                <div
                  className={`${isDarkMode ? 'bg-zinc-900 border-zinc-700' : 'bg-zinc-200 border-2 border-gray-300'} rounded-2xl p-4 hover:border-chart-3 transition-all duration-300`}
                >
                  <div className="flex items-start gap-3">
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p
                        className={`font-black ${isDarkMode ? 'text-white' : 'text-gray-900'} text-sm group-hover/card:text-chart-2 transition-colors`}
                      >
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-400 text-sm">{booking.provider.country}</p>
                    </div>
                  </div>
                </div>
              </div>
    ...
    {getCurrencySymbol(booking.currency)}
                      ...
                      <div>
                        <p
                          className={`${isDarkMode ? 'text-white/80' : 'text-gray-500'} text-sm font-bold uppercase`}
                        >
                          Total Amount
                        </p>
                        <p
                          className={`text-xl md:text-3xl font-black text-white" ${isDarkMode ? 'text-white' : 'text-gray-900'}`}
                        >
              ...
              {/* Action Buttons */}
              <div
                className={`flex flex-wrap gap-3 pt-6 border-t-2 ${isDarkMode ? 'border-zinc-700' : 'border-zinc-300'}`}
              >
                <button
