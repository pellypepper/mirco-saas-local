      ...
      >
        ...
        <div className="flex justify-between items-start p-6 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className={`text-xl font-black ${textPrimary}`}>Delete Booking</h2>
              <p className={`text-xs uppercase tracking-wider ${textMuted}`}>Permanent Action</p>
            </div>
          </div>
        ...
        <div className="px-6 pb-6">
          <div className={`rounded-2xl p-5 border-2 mb-6 ${surfaceSoft} ${border}`}>
            <p className={`text-sm leading-relaxed ${textSecondary}`}>
              Are you sure you want to delete{' '}
              <span className={`font-bold ${textPrimary}`}>{booking.services.title}</span>
              ?
              <br />
              <span className={textMuted}>This action only removes it from your view.</span>
            </p>
          </div>
