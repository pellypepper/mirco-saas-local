        ...
        <div>
          <nav className="sticky top-0 z-50  bg-zinc-950/90 backdrop-blur-md border-b border-zinc-800  flex justify-between items-center  w-full p-3 px-5 ">
            ...
            {open && (
              <div
                ref={menuRef}
                className="absolute z-90   bg-zinc-950/80 backdrop-blur-xl border border-white/10 w-[200px]  top-12 right-5 mt-4"
              >
                {role === 'provider' ? (
                  <ProviderNav
                    onChangeEmail={toggleEmail}
                    onChangePassword={togglePassword}
                    setOpen={setOpen}
