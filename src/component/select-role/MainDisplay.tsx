...
const ROLE_CONFIG = {
  customer: {
    ...
    icon: User,
    options: ['Browse and book services', 'Manage your bookings', 'View booking history'],
  },
  provider: {
    title: "I'm a Provider",
    description: 'Offer your services, manage bookings, and grow your business.',
    icon: Briefcase,
    options: ['Create and manage services', 'Set your availability', 'Track your bookings'],
  },
} as const;
