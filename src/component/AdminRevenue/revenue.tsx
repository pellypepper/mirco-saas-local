      ...
      <div className="flex flex-col lg:flex-row gap-4 mb-6">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 rounded-xl border border-slate-200 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
          />
        </div>
        <button
          onClick={handleFilterOpen}
          className="px-6 py-3 bg-white border-2 border-slate-200 rounded-xl font-medium hover:border-indigo-500 hover:text-indigo-600"
        >
          <Filter className="inline w-5 h-5 mr-2" /> Advanced Filters
        </button>
        <div className="relative group">
          <button className="px-6 py-3 bg-indigo-600 text-white rounded-xl flex items-center gap-2">
