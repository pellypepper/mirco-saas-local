...
const ProviderModal = ({
  ...
  setSelectedProvider: React.Dispatch<React.SetStateAction<any | null>>;
}) => {
  return (
    <div
      ...
      >
        ...
        <div className="bg-gradient-to-r from-chart-2/80 to-chart-3/80 px-8 py-6 text-white">
          <div className="flex justify-between items-start">
            <div>
              <h2 className="text-3xl font-bold mb-2">{selectedProvider.full_name}</h2>
            ...
            <div className="bg-slate-50 rounded-xl p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-slate-800 font-medium">{selectedProvider.email}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-slate-800 font-medium">{selectedProvider.country}</span>
                </div>
              </div>
            </div>
