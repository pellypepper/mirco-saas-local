      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
        ...
        <div className="space-y-3">
          ...
          {topProviders.length === 0 && (
            <p className="text-sm text-slate-500 text-center py-6">No provider data available.</p>
          )}
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
        ...
        <div className="space-y-3">
          ...
          {recentCustomers.length === 0 && (
            <p className="text-sm text-slate-500 text-center py-6">No recent customers found.</p>
          )}
        </div>
      </div>
    </div>
