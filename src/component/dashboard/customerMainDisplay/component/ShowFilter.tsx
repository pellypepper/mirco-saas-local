  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-24 px-4 animate-in fade-in duration-300">
      ...
      <div className="relative w-full max-w-2xl animate-in slide-in-from-top duration-500">
        <div
          className={`rounded-3xl overflow-hidden ${isDarkMode ? 'bg-zinc-800 border-zinc-700 shadow-2xl' : 'bg-white border-gray-300 shadow-lg'}`}
        >
          ...
          <div className="p-8">
            <div className="grid gap-6">
              ...
              <div className="space-y-3">
                <label className="flex items-center justify-between">
                  <span
                    className={`flex items-center gap-3 text-sm font-bold ${isDarkMode ? 'text-white' : 'text-black'} uppercase tracking-wider`}
                  >
                  ...
                  {serviceFilter !== 'All Services' && (
                    <span
                      className={`flex items-center gap-1.5 text-xs bg-chart-3 text-white px-3 py-1.5 rounded-full font-bold shadow-lg animate-in zoom-in duration-300`}
                    >
            ...
            {activeFilters > 0 && (
              <div
                className={`mt-8 ${isDarkMode ? 'bg-zinc-900 border-zinc-700' : 'bg-white border-gray-300'} border-2 rounded-2xl p-6 animate-in slide-in-from-bottom duration-300`}
              >
                <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-chart-2 rounded-full animate-pulse"></div>
                    <p
                      className={`text-sm ${isDarkMode ? 'text-zinc-300' : 'text-zinc-700'} font-semibold`}
                    >
