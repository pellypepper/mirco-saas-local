        ...
        <div className="p-8 space-y-6">
          ...
          <div className="relative group">
            ...
            >
              ...
              <div>
                <div
                  className={`font-black ${isDarkMode ? 'text-white' : 'text-zinc-700'} text-lg`}
                >
                  {provider.full_name}
                </div>
                <div
                  className={`text-sm ${isDarkMode ? 'text-zinc-400' : 'text-zinc-400'} font-medium`}
                >
          ...
          <div className="space-y-3">
            <label
              className={`text-sm font-bold uppercase tracking-wider flex items-center gap-2 ${isDarkMode ? 'text-white' : 'text-zinc-900'}`}
            >
            ...
            <div className="relative">
              ...
              >
                <div className="text-left flex-1">
                  {selectedService ? (
                    ...
                    <div
                      className={`${isDarkMode ? 'text-zinc-400' : 'text-zinc-700'} font-medium`}
                    >
                      Choose a service...
                    </div>
                  )}
              ...
              {isDropdownOpen && (
                <div
                  className={`absolute top-full left-0 right-0 mt-2 ${isDarkMode ? 'bg-zinc-900 border-zinc-700' : 'bg-white border-gray-300'} border-2 rounded-2xl shadow-2xl z-20 max-h-64 overflow-y-auto animate-in slide-in-from-top duration-300`}
                >
                  {services && services.length > 0 ? (
                    services.map((service) => (
                      ...
                      >
                        <div
                          className={`font-bold ${isDarkMode ? 'text-white' : 'text-zinc-900'} group-hover/item:text-chart-2 transition-colors duration-300`}
                        >
                          {service.title}
                        </div>
                        <div
                        ...
                        >
                          ...
                          <span
                            className={`font-bold ${isDarkMode ? 'text-white' : 'text-zinc-900'}`}
                          >
                            {service.price}
                          </span>{' '}
                          {service.currency}
                    ...
                    <div className="p-8 text-center">
                      <div
                        className={`inline-flex p-4 ${isDarkMode ? 'bg-zinc-800 border-zinc-700' : 'bg-white border-gray-300'} rounded-full border-2  mb-3`}
                      >
                        <Calendar
                          size={24}
                          className={`${isDarkMode ? 'text-zinc-600' : 'text-chart-2'}`}
                        />
                      </div>
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="relative group">
              ...
              <div
                className={`relative p-5 ${isDarkMode ? 'bg-zinc-900 border-zinc-700' : 'bg-white border-gray-300'} border-2 rounded-2xl hover:border-chart-2 transition-all duration-300`}
              >
                <div className="flex items-start gap-3">
                  <div
                    className={`p-2 ${isDarkMode ? 'bg-zinc-800 border-zinc-700' : 'bg-white border-gray-300'} rounded-lg border`}
                  >
                  ...
                  <div>
                    ...
                    <div
                      className={`font-bold ${isDarkMode ? 'text-white' : 'text-zinc-900'} text-sm`}
                    >
                      {formattedDate}
                    </div>
                  </div>
            ...
            <div className="relative group">
              ...
              <div
                className={`relative p-5 ${isDarkMode ? 'bg-zinc-900 border-zinc-700' : 'bg-white border-gray-300'} border-2 rounded-2xl hover:border-chart-3 transition-all duration-300`}
              >
                <div className="flex items-start gap-3">
                  <div
                    className={`p-2 ${isDarkMode ? 'bg-zinc-800 border-zinc-700' : 'bg-white border-gray-300'} rounded-lg border`}
          ...
          {selectedService && (
            <div className="relative overflow-hidden">
              <div
                className={`relative p-6 border-2 rounded-2xl ${isDarkMode ? 'border-white/20' : 'border-gray-300'}`}
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div
                      className={`p-2 ${isDarkMode ? 'bg-zinc-800 border-zinc-700' : 'bg-white border-gray-300'} backdrop-blur-sm rounded-lg`}
                    >
                      <CreditCard
                        size={20}
                        className={`${isDarkMode ? 'text-white' : 'text-chart-2'}`}
                      />
                    </div>
                    <div
                      className={`font-bold text-sm md:text-base ${isDarkMode ? 'text-white/90' : 'text-zinc-900'}`}
                    >
                      Session Fee
                    </div>
                  </div>
          ...
          >
            <CheckCircle
              size={22}
              className={selectedService ? 'group-hover:scale-110 transition-transform' : ''}
            />
            Confirm & Pay
          </button>
