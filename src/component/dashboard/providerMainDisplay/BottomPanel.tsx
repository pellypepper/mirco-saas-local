'use client';
import { AlertCircle, Activity, Bell, TrendingUp, Clock } from 'lucide-react';
    ...
    <div className="grid md:grid-cols-2 gap-6 ">
      ...
      <CardGlass isDarkMode={isDarkMode}>
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className={`text-2xl font-black ${isDarkMode ? 'text-white' : 'text-black'}`}>
            Needs Attention
          </h2>
        </div>
        ...
        <div className="space-y-3">
          {recentActivity.length === 0 ? (
            <div className="text-center py-12">
              <div
                className={`inline-flex p-4 ${isDarkMode ? 'bg-zinc-900' : 'bg-zinc-100'} rounded-full border ${isDarkMode ? 'border-zinc-700' : 'border-zinc-300'} mb-3`}
              >
            ...
            recentActivity.map((a: any, index: number) => (
              ...
              >
                ...
                <div className="relative flex-shrink-0">
                  ...
                  <div
                    className={`relative p-3 bg-chart-3 rounded-full border-2 ${isDarkMode ? 'border-zinc-700' : 'border-white'} group-hover:border-chart-3 transition-colors`}
                  >
                ...
                <div className="flex-1">
                  <p
                    className={`font-bold ${isDarkMode ? 'text-white' : 'text-black'} text-sm md:text-base mb-1 group-hover:text-chart-2 transition-colors`}
                  >
                    {a.message}
                  </p>
                  <div
      ...
      >
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className={`font-black ${isDarkMode ? 'text-white' : 'text-black'} text-base`}>
                {label}
              </p>
            </div>
          </div>
        ...
        {/* Progress bar */}
        <div
          className={`relative w-full h-3 mb-3 ${isDarkMode ? 'bg-zinc-900' : 'bg-zinc-100'} rounded-full overflow-hidden border border-zinc-700`}
        >
          {/* Background pattern */}
          <div
