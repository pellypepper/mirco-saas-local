    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-5 mb-10">
      <CardGradient isDarkMode={isDarkMode}>
        <div className="flex items-center gap-4">
          ...
          <div>
            <p
              className={`font-semibold ${isDarkMode ? 'text-white' : 'text-black'} text-xs md:text-sm mb-1`}
            >
              Today's Bookings
            </p>
            <p
              className={`text-sm md:text-2xl font-black ${isDarkMode ? 'text-white' : 'text-black'}`}
            >
              {stats.todayBookings}
            </p>
          </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex gap-2 items-center">
              ...
              />
              <span className={`font-black text-sm ${isDarkMode ? 'text-white' : 'text-black'}`}>
                {stats.averageRating}
              </span>
            </div>
          </div>
