...
export default function SlotForm({
  ...
  return (
    <div className="relative group/form">
      <div
        className={`relative p-4 ${formBg} border-2 ${formBorder} rounded-2xl ${formHoverBorder} transition-all duration-300`}
      >
        {/* Header */}
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className={`text-xs font-bold ${textPrimary} uppercase tracking-wider`}>
            Add Time Slot
          </span>
        </div>
