...
export default function SaveSection({
  ...
  return (
    <div
      className={`sticky bottom-6 ${bgPrimary} border-2 ${border} rounded-3xl shadow-2xl p-6 backdrop-blur-xl animate-in slide-in-from-bottom duration-500 transition-colors`}
    >
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <div className="group relative">
                ...
                <div
                  className={`relative flex items-center gap-2 ${statBg} border-2 ${statBorder} px-4 py-2 rounded-xl ${statHoverBorder} transition-all`}
                >
              ...
              <div className="group relative">
                ...
                <div
                  className={`relative flex items-center gap-2 ${statBg} border-2 border-chart-4/30 px-4 py-2 rounded-xl hover:border-chart-4 transition-all`}
                >
